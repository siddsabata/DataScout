...
def main():
    ...
    # Input search query
    user_input = st.text_input("Enter Topic: ", value="", max_chars=50)
    ...
    if st.button("Crawl these URLs"):
        user_input2 = st.text_input("Enter a question about the topic: ", value="", max_chars=50)
        crawler.crawler_input()
        client = ApifyClient(crawler.apify_api_token)
        data = client.actor("aYG0l9s7dbB7j3gbS").call(run_input=crawler.crawl_run_input)
        ...
        result = index.query_with_sources(user_input2)
